...
- Событие "потребовалось  больше трёх бросоков для достижения успеха" произойдёт, если первые три броска завершатся неудачей, т.е.  $$P(Y > 3) = \left(\cfrac{5}{6}\right)^3 = \cfrac{125}{216};$$
