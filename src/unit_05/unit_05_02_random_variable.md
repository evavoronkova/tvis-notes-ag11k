...
Игральный кубик подбрасывают дважды. 
 - Элементарное событие --- пара $(s, t)$, где $s,t$ --- очки, выпавшие при первом и втором подбрасывании, соответственно; 
 - $s, t \in \{1, 2, \ldots, 6\}$;
...
Пусть задана случайная величина $X:\Omega \to \{a_1, \ldots, a_k\}$, где $k \in \mathbb{N}, k\leqslant n$. Тогда  cобытия $A_i = \{X = a_i\}$ --- попарно не пересекаются и  в совокупности покрывают всё пространство $\Omega$, т.е.
...
Определение распредления вероятностей можно сформлировать и так:
